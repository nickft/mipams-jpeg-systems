...
public class ReplacementBoxTests extends AbstractIntegrationTests {
    ...
    void testBoxReplacementBoxWithOffset() throws Exception {
        ...
        JumbfBox jsonJumbfBox = MockJumbfBox.generateJumbfBoxWithContent(jsonBox,
                org.mipams.jumbf.core.util.BoxTypeEnum.JsonBox.getContentUuid());

        List<BmffBox> replacementDataBoxList = List.of(jsonJumbfBox);

        JumbfBox givenJumbfBox = getReplacementJumbfBoxBasedOnReplacementDescriptionBox(ReplacementType.BOX.getId(),
    ...
    void testAppReplacementBox() throws Exception {
        ...
        JumbfBox givenJumbfBox = getReplacementJumbfBoxBasedOnReplacementDescriptionBox(ReplacementType.APP.getId(),
    ...
    void testFileReplacementBox() throws Exception {
        ...
        JumbfBox givenJumbfBox = getReplacementJumbfBoxBasedOnReplacementDescriptionBox(ReplacementType.FILE.getId(),
    ...
    void testRoiReplacementBox() throws Exception {
        ...
        JumbfBox givenJumbfBox = getReplacementJumbfBoxBasedOnReplacementDescriptionBox(ReplacementType.ROI.getId(),
    ...
    private JumbfBox getReplacementJumbfBoxBasedOnReplacementDescriptionBox(int replacementTypeId,
            ParamHandlerInterface paramHandler, List<BmffBox> replacementDataBoxList) throws MipamsException {
        ...
        return MockJumbfBox.generateJumbfBoxWithContent(replacementBox,
                BoxTypeEnum.ReplacementBox.getContentUuid());
    }
}
