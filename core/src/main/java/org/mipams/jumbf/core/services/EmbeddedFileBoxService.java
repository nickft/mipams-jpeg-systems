...
public class EmbeddedFileBoxService extends XTBoxService<EmbeddedFileBox> {
    ...
    protected void populateBox(EmbeddedFileBox embeddedFileBox, ObjectNode input) throws MipamsException {
        ...
        if (!BoxTypeEnum.EmbeddedFileBox.getType().equals(type)) {
    ...
    private void writeUrlToJumbfBox(EmbeddedFileBox embeddedFileBox, FileOutputStream fileOutputStream)
            throws MipamsException {
        try {
    ...
    private void writeFileToJumbfBox(EmbeddedFileBox embeddedFileBox, FileOutputStream fileOutputStream)
            throws MipamsException {
        CoreUtils.writeFileContentToOutput(embeddedFileBox.getFileUrl(), fileOutputStream);
    }

    @Override
    protected void populatePayloadFromJumbfFile(EmbeddedFileBox embeddedFileBox, InputStream input)
            throws MipamsException {
